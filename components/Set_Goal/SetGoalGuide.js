...
const SetGoalGuide = () => {
  return (
    <ScrollView style={{ backgroundColor: "#FDF9E6", padding: 20 }}>
      ...
      <Text style={styles.text_footer_small}>
        Here are some examples of effective SMART goals.
      </Text>
      <Text style={styles.text_footer_small}>
        GOAL: Save £600 over the course of a year
      </Text>
      <Text style={styles.text_footer_small}>
        SUBGOALS: Save £50 each month
      </Text>
      <Text style={styles.text_footer_small}>
        GOAL: Pass a Spanish exam in two months
      </Text>
      <Text style={styles.text_footer_small}>
        SUBGOALS: Practice for at least an hour each week
      </Text>
      <Text style={styles.text_footer_small}>
        GOAL: Finish writing a screenplay in 7 months
      </Text>
      <Text style={styles.text_footer_small}>
